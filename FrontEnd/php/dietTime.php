...
<html lang="en">
  ...
  <body>
    ...
    <div class="box">
      <center>
        <h1><strong>Choose.</strong></h1>
        <br>
        <br>
        <form action="daily.php" method="POST">
          <button type="submit" class="btn btn-dark"><strong>Daily</strong></button>
        </form>
        <br>
        <form action="week.php" method="POST">
          <button type="submit" class="btn btn-dark"><strong>Weekly</strong></button>
        </form>
        <br>
        <form action="month.php" method="POST">
          <button type="submit" class="btn btn-dark"><strong>Monthly</strong></button>
        </form>
